...
class DBTransactionAccepted extends StatefulWidget {
  static String tag = '/DBConfirmationComponent';

  var status;

  DBTransactionAccepted({this.status});
  @override
  DBTransactionAcceptedState createState() => DBTransactionAcceptedState();
}

class DBTransactionAcceptedState extends State<DBTransactionAccepted> {
  @override
  void initState() {
    super.initState();
    init();
